...
/**
 *  The passcode screen has to be manually opened. You decide when it should be
 * presented.
 *  The chosen code is stored inside the keychain.
 *  First let the user set a passcode by calling the
 * setupPasscodeInViewController:completion: method.
 *  If you want to authenticate the user, simple call
 * showPasscodeInViewController:completion.
 */
 ...
 *
 *  @param viewController The view controller in which the passcode screen will
 *be presented
 *  @param completion     The completion block with a BOOL to inidcate if
 *authentication was successful (and NSError if not)
 */
 ...
 *  @param viewController The view controller in which the passcode screen will
 *be presented
 *  @param completion     The completion block with a BOOL to inidcate if the
 *authentication was successful (and NSError if not)
 */
