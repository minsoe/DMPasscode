...
- (instancetype)init {
  if (self = [super init]) {
    ...
    self.errorBackgroundColor =
        [UIColor colorWithRed:0.63 green:0.00 blue:0.00 alpha:1.00];
    ...
    self.descriptionTextColor = [UIColor colorWithWhite:0.2 alpha:1.0];
    self.descriptionFont = [UIFont systemFontOfSize:16];
  }
  return self;
}
